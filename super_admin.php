...
<body>
    <div class="background" id="background">
       ...
       <h1 class="wel" id="wel"> welcome to ABC Dear Owner <?php echo " ". $_SESSION['name']?>! </h1>
       ...
       <form action="super_admin.php" method="post"  enctype="multipart/form-data">
        <div id="add_items_inform">
            ...
            <labal for="protect_path" id="chose">chose image</labal>
        ...
        <div id="add_admin_details">
        <button id="back4">Back</button>
            <label for="adimn_name">Enter name: </label>
            <input type="text" name="admin_name" id=""><br>
            <labal for="admin_email">Admin's email: </labal>
            <input name="admin_email" type="email" ><br>
            <label for="password">Admin's password:</label>
            <input type="text" name="admin_password" id=""><br>
            <button id="move_admin_details" name="move_admins_details">Submit</button>
        </div>
       </form>
       <button id="add_iterms">Add iterms</button>

       <button id="add_admin">Add admins</button>
    ...
    <?php 
          ...
          if (mysqli_num_rows($res) > 0) {
           ...
           <h1 id="leb_name"><?php echo $images['price'] ."$" ?></h1>
           <button id="buy">buy</button>
             </div>
    ...
    x.addEventListener('click',redark);
      ...
      document.getElementById("back4").onclick=function remove(){
        document.getElementById("add_admin_details").style.display='none';
        document.getElementById("add_admin_details").style.height='0%';
        event.preventDefault();
      }
